...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"الأولى",sLast:"الأخير",sNext:"التالي",sPrevious:"السابقة"},sEmptyTable:"ﻻ يوجد بيانات حالياً",sInfo:"عرض _START_ الى _END_ من _TOTAL_ صف",sInfoEmpty:"عرض 0 الى 0 من 0",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
